    ...
    return {
        init: function () {
            ...
            var oTable = $('#editable-sample').dataTable({
                ...
                "iDisplayLength": 5,
                "sDom": "<'row'<'col-lg-6 fl'l><'col-lg-6 fl'f>r>t<'row'<'col-lg-6 fr'i><'col-lg-6 fr'p>>",
                "sPaginationType": "bootstrap",
                "oLanguage": {
                    "sLengthMenu": "_MENU_ 选择显示行数",
                    "oPaginate": {
                        "sPrevious": "上一页",
                        "sNext": "下一页"
                    }
            ...
            $(document).ready(function() {
                $('#editable-sample a.delete').click(function() {
